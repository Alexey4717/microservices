...
import { OAUTH_CANCELLED_MESSAGE, OauthButtons } from '../oauth-buttons';

type RegisterFormProps = {
  oauthError?: boolean;
};

export function RegisterForm({ oauthError = false }: RegisterFormProps) {
    ...
    <div className="flex flex-col gap-4">
      <form action={formAction} className="flex flex-col gap-4">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          Создайте аккаунт. Имя можно не указывать.
        </p>
